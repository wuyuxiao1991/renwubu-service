...
public class MilitaryStrengthRegistrationHandler implements ExcelHandler {
    ...
    public String getExcelType() {
        return "military_strength_registration";
    }
    ...
    public void upload(MultipartFile file, String identity) {
        ...
        for (int i = 8; i < rowNum; i++) {
            ...
            insertMilitaryStrengthRegistration(row, identity);
        }
    }
    ...
    public String download(String identity) throws IOException {
        ...
        //3.写入新文件
        String downloadFilePath = url + "military_strength_registration.xlsx";
        FileOutputStream fileOut = new FileOutputStream(downloadFilePath);
        wb.write(fileOut);
        fileOut.close();

        return mappingUrl + "military_strength_registration.xlsx";
    }
    ...
    private Workbook getWorkbook() throws IOException {
        String peopleDetailTemplatePath = templateUrl + "military_strength_registration.xlsx";
    ...
    private void fillRows(MilitaryStrengthRegistration militaryStrengthRegistration, Sheet sheet, int i) {
        ...
        row.createCell(67).setCellValue(militaryStrengthRegistration.district);
    }
}
